...
const Navbar = () => {
  ...
  const NavLinks = (
    <nav className='flex gap-3 md:gap-4 lg:gap-10 lg:text-xl text-[18px]'>
      ...
      <NavLink to='/whyTasky'>Why MTask</NavLink>
  ...
  return (
    <nav className='backdrop-blur bg-white/50'>
          ...
          <div className='relative'>
            {user ? (
              ...
              >
                ...
                <img
                  className='w-11 h-11 rounded-full border-2 border-[#03b97c]'
                  src={user.photoURL}
                  alt='user photo'
                />
              </button>
              ...
              <Link to='/login'>
                <button className='md:px-6 rounded bg-[#03b97c] md:py-3 text-xl px-3 py-2 mr-1 text-white'>
                  Login
                </button>
              </Link>
            )}
        ...
        {isMobileMenuOpen ? (
          ...
          >
            <ul className='flex flex-col p-4 space-y-4 text-center'>
              <li className='block text-gray-900  hover:text-lime-600'>
                <NavLink to='/'>Home</NavLink>
              </li>
              <NavLink to='/whyTasky'>Why MTask</NavLink>
