              ...
              {(provided) => (
                ...
                >
                  <div className='h-[500px]'>
                    <h1 className='text-center py-5 capitalize'>todo</h1>
                    {todo?.map((task, index) => (
                      <Draggable
                        key={task._id}
                      ...
                      >
                        {(provided) => (
                          <div
                            ...
                            className='w-full justify-center mx-auto max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 mb-5'
                          >
          ...
          <div>
            <Droppable droppableId='progress'>
              {(provided) => (
                ...
                >
                  <div className='h-[500px]'>
                    <h1 className='text-center py-5 capitalize'>
                      progress
                    </h1>
